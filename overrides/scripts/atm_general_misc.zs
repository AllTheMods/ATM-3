...
//	
	...
	function empPressRecipe(x as IItemStack, y as IItemStack, z as float[]){
		...
		mods.actuallyadditions.Empowerer.addRecipe(y, pressCalc, x, blockSkyS, dustSkySt, dustSkySt, 5000, 200, z);
		mods.actuallyadditions.Empowerer.addRecipe(y, pressEngi, x, blockSkyS, dustSkySt, dustSkySt, 5000, 200, z);
		mods.actuallyadditions.Empowerer.addRecipe(y, pressLogi, x, blockSkyS, dustSkySt, dustSkySt, 5000, 200, z);
		mods.actuallyadditions.Empowerer.addRecipe(y, pressSili, x, blockSkyS, dustSkySt, dustSkySt, 5000, 200, z);
    }
