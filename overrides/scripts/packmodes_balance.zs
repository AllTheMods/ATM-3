...
/*
Extreme Reactors Tweaks for balance
*/    
	...
	//Reactor Controller
		...
		recipes.addShaped(<bigreactors:reactorcontroller>, [
			[<bigreactors:reactorcasing>, <bigreactors:reactorcasing>, <bigreactors:reactorcasing>], 
			[<bigreactors:reactorcasing>, <nuclearcraft:fission_controller_idle>, <bigreactors:reactorcasing>], 
			[<bigreactors:reactorcasing>, <bigreactors:reactorcasing>, <bigreactors:reactorcasing>]
			]);
...
// arguments about how water-mills 
// aren't the 100% most overused OP GP source 
// --Ord
//
...
//====== Disable EFLN ======
// Bypasses claims -- possible griefing tool
//
...
//
	...
	//toastertim's Spikes
	/*
	var spikeWood = <spikemod:wooden_spike>;
	var spikeStone = <spikemod:stone_spike>;
	var spikeIron = <spikemod:iron_spike>;
	var spikeGold = <spikemod:golden_spike>;
	var spikeDiamond = <spikemod:diamond_spike>;
	var spikeSpecial = <spikemod:looting_spike>;
	*/
...
//
    ...
    recipes.addShapeless(<quantumstorage:quantumstoragedisk>.withTag({Items: [], Stored: 0, Protocol: 1}), [
        <quantumstorage:quantumcrafter>, <atmtweaks:item_material:8>
    ]);
